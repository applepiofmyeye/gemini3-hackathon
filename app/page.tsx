      ...
      <div className="container mx-auto px-4 py-8 flex flex-col items-center min-h-screen">
        ...
        <header className="mb-8 text-center pt-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-4">
            {LOGO_COLORS.map((item, i) =>
              item.letter === ' ' ? (
                ...
                <span key={i} className="logo-letter" style={{ color: item.color }}>
                  {item.letter}
                </span>
              )
            )}
          ...
          <p className="text-lg text-gray-600 max-w-lg mx-auto leading-relaxed">
            ...
            <br />
            <span className="text-sm text-gray-500">Powered by Gemini 2.0 Flash Live API</span>
          </p>

          {/* Quick Stats Badge */}
          <div className="mt-4 inline-flex items-center gap-3 px-4 py-2 bg-white/80 rounded-full shadow-sm">
            <span className="flex items-center gap-1.5">
              <span className="w-3 h-3 rounded-full" style={{ backgroundColor: '#D42E12' }} />
              <span className="w-3 h-3 rounded-full" style={{ backgroundColor: '#009645' }} />
              <span className="w-3 h-3 rounded-full" style={{ backgroundColor: '#FA9E0D' }} />
              <span className="w-3 h-3 rounded-full" style={{ backgroundColor: '#9900AA' }} />
              <span className="w-3 h-3 rounded-full" style={{ backgroundColor: '#005EC4' }} />
            </span>
